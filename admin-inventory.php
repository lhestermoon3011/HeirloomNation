...
<html>
<head>
	<title>Inventory &bull; HeirloomNation</title>
    ...
    <div class="container" style="margin-top: 50px; margin-bottom: 75px;">
        <div class="row margin-top" style="margin-bottom: -12px;">
    		<div class="col-lg-6 col-sm-6">
    			...
    			<a data-toggle="modal" data-target="#addcat" class="btn btn-warning  margin-left pull-left" style="margin-top: 20px;"><i class="fa fa-plus fa-fw"></i> Add Category</a>
    			<a data-toggle="modal" data-target="#modal-unitsettings" class="btn btn-warning margin-left-sm pull-left" style="margin-top: 20px;"><i class="fa fa-archive fa-fw"></i> Unit Settings</a>
    		</div>	
    	</div>
		...
		<ul class="nav nav-pills nav-justified">
			...
			?>
		  	<li class="active"><a href="admin-inventory.php">All Items</a></li>
		  <?php
    		...
    		<div class="col-lg-6 col-sm-6">	
				<div class="btn-group pull-right margin-top">
					<div class="input-group search-unextended pull-left">
					    ...
					    <input type="text" class="form-control" name="search" placeholder="Search item..." onkeyup="load_process ('item-container', '../functions/search-module.php?search-item-2='+this.value)" autocomplete="off">
					</div>
				</div>	
			</div>	
    	</div>
