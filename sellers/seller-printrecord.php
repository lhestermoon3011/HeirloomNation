...
<body>
	<div class="container margin-top-lg">
		<a href="seller-records.php" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Return</a>
		<button class="btn btn-success" onclick="print_function ('printarea')"><i class="fa fa-print fa-fw"></i>Print Record</button>
				...
				<div class="row">
					...
					<div class="col-lg-10">
						<center>
							...
							<p class="margin-top-lg margin-bottom-lg">OFFICIAL RECORD as of <?=date("Y/m/d");?> (<?=date("l");?>) - <?=date("h:i:s");?></p>
						</center>
