...
<?php include "seller-navbar.php";?>
    <div class="container" style="margin-top: 50px; margin-bottom: 100px;">
		...
		<ul class="nav nav-pills nav-justified">
			...
			?>
		  	<li><a href="seller-inventory.php">All Items</a></li>
		  <?php
			...
			while ($category_row = $category_query->fetch()) {
				...
				?>
				<li class="active"><a href="seller-category.php?cat_id=<?=$category_row['cat_id'];?>"><?=$category_row['category_name'];?></a></li>
				<?php	
				}
				else {
				?>
    		...
    		<div class="col-lg-6 col-sm-6">	
				<div class="btn-group pull-right margin-top">
					<div class="input-group search-unextended pull-left">
					    ...
					    <input type="text" class="form-control" name="search" placeholder="Search item" onkeyup="load_process ('item-container', '../functions/search-module.php?seller_id=<?=$seller_row['acc_id'];?>&cat_id=<?=$cat_row['cat_id'];?>&search-item-5='+this.value)" autocomplete="off">
					</div>
				</div>	
			</div>	
    	</div>
