	...
	<div class="container" style="margin-top: 75px; margin-bottom: 75px;">
		<div class="row">
			<div class="col-lg-4 col-sm-4">
				<a href="index.php" class="btn btn-warning margin-bottom-lg"><i class="fa fa-arrow-left fa-fw"></i> Return</a>	
			</div>
			<div class="col-lg-8 col-sm-8">
				<div class="btn-group pull-right">
					<?php
						...
						?>
						<button type="button" data-toggle="modal" data-target="#modal-addtocart" class="btn btn-default"><i class="fa fa-shopping-cart fa-fw"></i> Add to Cart</button>
						<?php		
						}
						else {
						?>
						<button type="button" class="btn btn-default disabled"><i class="fa fa-shopping-cart fa-fw"></i> Add to Cart</button>
						<?php	
						}
					?>
					<a href="cos-message.php?seller_id=<?=$seller_row['acc_id'];?>" class="btn btn-default"><i class="fa fa-envelope fa-fw"></i> Message <?=$seller_row['firstname'];?> <?=$seller_row['lastname'];?></a>
				</div>	
			</div>	
		</div>
		<?php
