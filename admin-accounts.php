    ...
    <div class="container"  style="margin-top: 50px; margin-bottom: 75px;">
		<h2><i class="fa fa-users fa-fw"></i> Accounts</h2>
			...
			<ul class="nav nav-pills nav-justified margin-bottom-lg">
			  <li class="active"><a class="btn" href="admin-accounts.php">Admin Accounts</a></li>
			...
			<div class="row">
				<div class="col-lg-6 col-sm-6">
					<a data-toggle="modal" data-target="#modal-addaccount" class="btn btn-warning margin-bottom-lg"><i class="fa fa-plus fa-fw"></i> Add Admin</a>	
				</div>
				<div class="col-lg-6 col-sm-6">
					<div class="input-group search-unextended pull-left">
					    <span class="input-group-addon"><i class="fa fa-search"></i></span>
					    <input type="text" class="form-control" name="search" placeholder="Search admin..." onkeyup="load_process ('admin-container', '../functions/search-module.php?search-admin='+this.value)" autocomplete="off">
					</div>
				</div>
			</div>
			<?php
